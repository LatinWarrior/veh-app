...
gulp.task('copyProjectFiles', function () {
	return gulp
		.src(['public/dist/**/*.html', 'public/dist/**/*.json'])
		.pipe(debug())
		.pipe(gulp.dest('public/dist'));
});
...
gulp.task('serve', ['scripts', 'copyLayoutFile', 'copyExternalLibraries', 'copyProjectFiles', 'inject'], function () {
